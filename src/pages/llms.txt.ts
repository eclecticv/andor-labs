...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "  than a vibe.",
    "- Durability replaced an earlier 'would you invest' question, which",
    "  systematically punished acquired companies: it asked the model to imagine",
    "  a transaction, so anything making that transaction impossible read as a",
    "  defect in the company. Acquisition is treated as an outcome, not a verdict.",
